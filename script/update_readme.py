...
if __name__ == "__main__":
    ...
    badge_instruction = (
        ...
        "Integrate them stylistically at the very top of the document (e.g., grouped neatly and centered using HTML `<p align=\"center\"> </p>` tags directly under the main title, <a href=""><img src="" alt=""></a>) rather than randomly placing them."
